    ...
    <AgencyChrome>
      ...
      <div className="relative">
        ...
        <div className="mx-auto max-w-5xl px-4">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-8">
              <div>
                ...
                <p className="mt-3 text-white/70 max-w-2xl">
                  OpSec inspects Base tokens like a covert review team—source verification,
                  ownership &amp; proxy checks, supply concentration, liquidity strength,
                  market behavior, honeypot/GoPlus flags, and explorer/social signals.
          ...
          <section className="mt-8 grid md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                title: "2) Deep Scan",
                body:
                  "We query BaseScan, GoPlus, DEX Screener, Honeypot and on-chain reads; we also consider explorer/social signals when available.",
              },
              {
                title: "3) Share",
                body:
          ...
          {/* SCORING EXPLAINER (aligned with v2 in lib/opsec/score.ts) */}
          <section className="mt-8 rounded-2xl border border-white/10 p-6 bg-[radial-gradient(ellipse_at_top,rgba(0,255,149,0.06),transparent_60%)] shadow-[0_0_30px_-15px_rgba(0,255,149,0.35)]">
            ...
            <p className="mt-1 text-white/70 max-w-3xl">
              The score is 0–100 with a letter grade. Each category aggregates weighted checks.
              Unknown signals are treated as <em>neutral</em> (half credit) rather than failures,
              so newer or lower-info tokens aren’t unfairly penalized. The most impactful findings
              appear in the report “Summary,” with detailed items below.
            </p>
